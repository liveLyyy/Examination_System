...
public class StudentController {
    ...
    public String outCourse(int id) throws Exception {
        ...
        Selectedcourse selectedCourseCustom = new Selectedcourse();
    ...
    public String selectedCourse(Model model) throws Exception {
        //获取当前用户名
        Subject subject = SecurityUtils.getSubject();
        StudentCustom student = (StudentCustom) studentService.findStudentAndSelectCourseListByName((String) subject.getPrincipal());
        List<SelectedCourseCustom> list = student.getSelectedCourseList();
